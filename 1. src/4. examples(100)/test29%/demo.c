...
int main(void)
{
	...
	i32Ret = scanf("%lld", &i32InputNumber);// 键盘输入一个少于五位数
	if(i32Ret <= 0)
	{
	...
	if(i32NumberThousandTen != 0)// 若输入的数为五位数
	{
		printf("%d%d%d%d%d\n", i32NumBit, i32NumberTen, i32NumberBest, i32NumberThousand, i32NumberThousandTen);
	}
	else if (i32NumberThousand != 0)// 若输入的数为四位数
	{
		printf("%d%d%d%d\n", i32NumBit, i32NumberTen, i32NumberBest, i32NumberThousand);
	}
	else if (i32NumberBest != 0)// 若输入的数为三位数
	{
		printf("%d%d%d\n", i32NumBit, i32NumberTen, i32NumberBest);
	}	
	else if (i32NumberTen != 0)// 若输入的数为二位数
	{
		printf("%d%d\n", i32NumBit, i32NumberTen);
	}
	else
	{
		printf("%d\n", i32NumBit);
